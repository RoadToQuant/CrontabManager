...
class CrontabManager:
    ...
    def _build_cron_line(self, task_id: int, name: str, cron: str, 
                         script_path: Path, enabled: bool = True) -> str:
    ...
    def add_or_update_task(self, task_id: int, name: str, cron: str, 
                           ...
                           env_vars: str = "{}", enabled: bool = True) -> Optional[Path]:
        ...
        new_entry = self._build_cron_line(task_id, name, cron, script_path, enabled)
